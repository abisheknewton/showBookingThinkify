...
public class MainStarterMethod {
	...
	public static void main(String[] args) {
			...
			while(true) {
				...
				switch(choice) {
					case 1 : response=showService.registerShow(); break;
					case 2 : response=showService.onboardShowSlots();break;
					case 3 : showService.viewAvailableShowsByGenre();break;
					case 4 : response = bookingService.addBooking();break;
					case 5 : response = bookingService.cancelBooking();break;
					case 6 : bookingService.viewAllBookings();break;
					case 7 : showService.viewTrendingShow();break;
					case 8 : showService.viewRegisteredShows();break;
